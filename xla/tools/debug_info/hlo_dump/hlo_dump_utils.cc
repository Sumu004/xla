...
std::string SerializeGraphDataCompressed(const GraphData& data) {
  ...
  absl::little_endian::Store32(node_count_buf, node_count);
  ...
  for (const auto& node : data.nodes) {
    ...
    absl::little_endian::Store64(buffer, id);
    binary_data.append(buffer, sizeof(id));
    absl::little_endian::Store32(buffer, absl::bit_cast<uint32_t>(x));
    binary_data.append(buffer, sizeof(x));
    absl::little_endian::Store32(buffer, absl::bit_cast<uint32_t>(y));
    binary_data.append(buffer, sizeof(y));
    absl::little_endian::Store32(buffer, absl::bit_cast<uint32_t>(diff_score));
    binary_data.append(buffer, sizeof(diff_score));
    absl::little_endian::Store64(buffer, anchor_id);
    binary_data.append(buffer, sizeof(anchor_id));
    absl::little_endian::Store16(buffer, key_len);
  ...
  absl::little_endian::Store32(edge_count_buf, edge_count);
  ...
  for (const auto& edge : data.edges) {
    ...
    absl::little_endian::Store64(buffer, supplier_id);
    binary_data.append(buffer, sizeof(supplier_id));
    absl::little_endian::Store64(buffer, consumer_id);
